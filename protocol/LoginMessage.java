...
public class LoginMessage implements ProtocolMessage 
{
	 ...
	 * NRF: This method takes as input a string generated by generateMessage() on the
	 * 		client side and returns a string to be sent back to the client as a response 
	 ...
	 * 		NRF: ClientUser is programmed to throw a LoginException if the userid is set to 0.
	 ...
	 * NRF: You are correct. There is no good reason for setUser to be public.
	 * 		I didn't consider the danger clear or present.
	 */
	...
	//NRF: This probably doesn't need to be public either, although there's no inherent danger.
